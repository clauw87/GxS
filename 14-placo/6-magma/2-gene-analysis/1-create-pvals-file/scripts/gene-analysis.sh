...
OUT=${OUTPUT_DIR}/gene.analysis

COMMAND="${MAGMA_FOLDER}/magma --bfile ${BFILE} --gene-annot ${GENE_ANNOT}.genes.annot --pval ./real/outputs/${CODE}.pvals use=SNP,PVAL ncol=N --gene-model snp-wise=top --out ${OUT}"
