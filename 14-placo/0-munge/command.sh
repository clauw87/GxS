...
main(){
  ...
  # gral format
  find $(readlink -f /gpfs42/projects/lab_anavarro/disease_pleiotropies/gxs/gxs_postgwas/01-format/real/outputs/) -iname *.formatted.sumstats.gz  | grep ADr1u   > real/inputs/formatted.list.new
