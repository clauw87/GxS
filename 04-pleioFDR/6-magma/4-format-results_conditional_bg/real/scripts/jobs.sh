...
DB=$(basename $FILE | cut -d '.' -f3,4 | sed 's/.v2023//g')


Rscript ./real/scripts/check_results_textable.R $FILE $CODE $DB
#Rscript ./real/scripts/check_results.R $FILE
