...
main(){
  ...
  do      
    ...
    # Limit to plain txt
  cat ./real/tmp/jobsList_f.txt | grep -v gz | grep -v tar | grep -v zip  | grep txt > ./real/inputs/jobsList_f.txt
  ...
  cat ./real/tmp/jobsList_m.txt | grep -v gz | grep -v tar | grep -v zip  | grep txt > ./real/inputs/jobsList_m.txt
