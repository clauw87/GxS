...
main(){
  ...
  ls ./real/tmp/*.gz  > ./real/inputs/downloaded.sumstats.list
       
  SUMSTATS_LIST=./real/inputs/downloaded.sumstats.list 
...
#exit
  ...
  # Execution
  # Cluster execution
  JOBS_COUNT=$(cat ./real/inputs/downloaded.sumstats.list | wc -l)
