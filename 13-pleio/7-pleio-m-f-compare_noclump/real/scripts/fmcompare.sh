...
# f
zcat ../3-preprocess/real/outputs/${fpair}/metain.txt.gz | head -n1 > ./real/tmp/${fpair}.txt
zcat ../3-preprocess/real/outputs/${fpair}/metain.txt.gz | grep -f ./real/tmp/${mpair}_${fpair}_common_snps.txt >> ./real/tmp/${fpair}.txt 


# m 
zcat ../3-preprocess/real/outputs/${mpair}/metain.txt.gz | head -n1 > ./real/tmp/${mpair}.txt
zcat ../3-preprocess/real/outputs/${mpair}/metain.txt.gz | grep -f ./real/tmp/${mpair}_${fpair}_common_snps.txt   >> ./real/tmp/${mpair}.txt
