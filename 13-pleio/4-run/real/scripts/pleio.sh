...
python ./real/scripts/pleio/pleio.py --metain ../3-preprocess/real/outputs/${CODE}/metain.txt.gz --sg ../3-preprocess/real/outputs/${CODE}/sg.txt.gz --ce ../3-preprocess/real/outputs/${CODE}/ce.txt.gz --create --out real/outputs/${CODE}/pleio
