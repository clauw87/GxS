...
GENESETS_FILE=./real/inputs/c5.go.bp.v2023.1.Hs.entrez.gmt
BACKGROUND_FILE=./real/inputs/bp_background.gmt


cat ${GENESETS_FILE}  > ./real/tmp/msigdb.v2023.2.sets
cat ${BACKGROUND_FILE} >> ./real/tmp/msigdb.v2023.2.sets


SETS_FILE=./real/tmp/msigdb.v2023.2.sets

OUT=./real/outputs/${TRAIT}.geneset.analysis
