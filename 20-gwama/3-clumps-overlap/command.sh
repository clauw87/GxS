...
main(){
  ...
  ls ../3-clump/real/outputs/*/result.clump.loci.csv > ./real/inputs/loci.files

  FILES_LIST=./real/inputs/loci.files
  ...
  ./real/scripts/file_combinations.sh ${FILES_LIST} ${TMP_DIR}/phenoscomb
 
  INPUTS_LIST=${TMP_DIR}/phenoscomb
  

  COMMAND=" \
    ./real/scripts/run_overlap.sh \
	${INPUTS_LIST} \
	${INPUTS_DIR} \
	${OUTPUTS_DIR}
  "
